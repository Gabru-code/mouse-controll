...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		cv2.line(image,(finger_tip_x,finger_tip_y),(thumb_tip_x,thumb_tip_y),(255,90,189),4)
		...
		cv2.circle(image,(center_x,center_y),2,(255,0,0),3)
		...
		print("mouse position",mouse.position,"tips line center position",center_x,center_y)
